...
def plot_chart(df, name, gann_show, fib_show, chan_show):
    ...
    # 2. 均线全家桶 (MA5,10,20,30,60) - 独立中文名与配色
    ma_config = {
        'MA5': ('MA5 (5日)', '#333333'),   # 黑灰
        'MA10': ('MA10 (10日)', '#ffcc00'), # 黄色
        'MA20': ('MA20 (20日)', '#cc33ff'), # 紫色
        'MA30': ('MA30 (30日)', '#2196f3'), # 蓝色
        'MA60': ('MA60 (60日)', '#4caf50')  # 绿色
    }
